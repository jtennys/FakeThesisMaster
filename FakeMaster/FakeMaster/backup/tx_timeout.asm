...
export  TX_TIMEOUT_bReadCompareValue
export _TX_TIMEOUT_bReadCompareValue
export  TX_TIMEOUT_bReadTimer
export _TX_TIMEOUT_bReadTimer
export  TX_TIMEOUT_bReadTimerSaveCV
export _TX_TIMEOUT_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bTX_TIMEOUT_ReadCompareValue  ; deprecated
export _bTX_TIMEOUT_ReadCompareValue  ; deprecated
export  bTX_TIMEOUT_ReadTimer         ; deprecated
export _bTX_TIMEOUT_ReadTimer         ; deprecated
export  bTX_TIMEOUT_ReadTimerSaveCV   ; deprecated
export _bTX_TIMEOUT_ReadTimerSaveCV   ; deprecated

export  bTX_TIMEOUT_ReadCounter       ; obsolete
export _bTX_TIMEOUT_ReadCounter       ; obsolete
export  bTX_TIMEOUT_CaptureCounter    ; obsolete
export _bTX_TIMEOUT_CaptureCounter    ; obsolete
...
_TX_TIMEOUT_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TX_TIMEOUT_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_TX_TIMEOUT_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[TX_TIMEOUT_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 TX_TIMEOUT_bReadCompareValue:
_TX_TIMEOUT_bReadCompareValue:
 bTX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
_bTX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TX_TIMEOUT_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 TX_TIMEOUT_bReadTimerSaveCV:
_TX_TIMEOUT_bReadTimerSaveCV:
 bTX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
_bTX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
 bTX_TIMEOUT_ReadCounter:                        ; this name deprecated
_bTX_TIMEOUT_ReadCounter:                        ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[TX_TIMEOUT_CONTROL_REG]          ; save the Control register
   push  A
   mov   A, reg[TX_TIMEOUT_COMPARE_REG]          ; save the Compare register
   push  A
   mov   A, reg[TX_TIMEOUT_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[TX_TIMEOUT_COMPARE_REG]          ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_TIMEOUT_bReadTimer
;
;  DESCRIPTION:
...
;
 TX_TIMEOUT_bReadTimer:
_TX_TIMEOUT_bReadTimer:
 bTX_TIMEOUT_ReadTimer:                          ; this name deprecated
_bTX_TIMEOUT_ReadTimer:                          ; this name deprecated
 bTX_TIMEOUT_CaptureCounter:                     ; this name deprecated
_bTX_TIMEOUT_CaptureCounter:                     ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[TX_TIMEOUT_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[TX_TIMEOUT_COMPARE_REG]          ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
