...
LCD_2_Port:           equ    PRT2DR
LCD_2_PortMode0:      equ    PRT2DM0
LCD_2_PortMode1:      equ    PRT2DM1
...
;
 LCD_2_WCNTL_Nibble:
    ...
    and   [Port_2_Data_SHADE],~LCD_2_PORT_MASK
...
LCD_2_WDATA_Nibble:
    ...
    RAM_SETPAGE_CUR >Port_2_Data_SHADE          ; Set CUR_PP to LCD variable address
    and   [Port_2_Data_SHADE],~LCD_2_PORT_MASK
    or    [Port_2_Data_SHADE],LCD_2_RS                ; Raise RS to signify a Data Write
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_2_Port],A
...
LCD_2_Check_Ready:
    ...
    RAM_SETPAGE_CUR >Port_2_Data_SHADE                ; Set CUR_PP to LCD variable address
    and   [Port_2_Data_SHADE],~LCD_2_PORT_MASK        ; Mask of all LCD bits
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_2_Port],A                           ; Zero LCD port bits

    and   [Port_2_DriveMode_0_SHADE],~LCD_2_DATA_MASK ; Clear out LCD mode bits.
    ...
    or    [Port_2_Data_SHADE],LCD_2_RW                ; Raise RW to signify Read operation
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_2_Port],A
    NOP
...
.LCD_RDY_LOOP:
    or    [Port_2_Data_SHADE], LCD_2_CNTL_READ                  ; Raise E to start cycle
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_2_Port],A
...
ENDIF   
    ...
    push  A
    and   [Port_2_Data_SHADE],(~LCD_2_PORT_MASK | LCD_2_RW)     ; Lower E signal
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_2_Port],A
...
.UNLOCK:
    ...
    or    [Port_2_DriveMode_0_SHADE],LCD_2_PORT_WRITE ; Revert Data bit to Write mode
    mov   A,[Port_2_DriveMode_0_SHADE]
    M8C_SetBank1
...
_LCD_2_Init:
    ...
    and   [Port_2_DriveMode_0_SHADE],~LCD_2_PORT_MASK           ; Mask off LCD bits
    or    [Port_2_DriveMode_0_SHADE],LCD_2_PORT_WRITE           ; Set LCD port for writing
    and   [Port_2_DriveMode_1_SHADE],~LCD_2_PORT_MASK           ; Mask off LCD bits
