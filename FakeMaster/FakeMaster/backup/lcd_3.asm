...
export   LCD_3_WriteData
export  _LCD_3_WriteData

export   LCD_3_Control
export  _LCD_3_Control

export  LCD_3_PrString
export _LCD_3_PrString

export  LCD_3_PrCString
export _LCD_3_PrCString

export  LCD_3_Position
export _LCD_3_Position

export  LCD_3_PrHexByte
export _LCD_3_PrHexByte

export  LCD_3_PrHexInt
export _LCD_3_PrHexInt

export  LCD_3_Delay50uTimes
export _LCD_3_Delay50uTimes

export  LCD_3_Delay50u
export _LCD_3_Delay50u
...
export  LCD_3_InitBG
export _LCD_3_InitBG

export  LCD_3_InitVBG
export _LCD_3_InitVBG
...
;
; Fastcall16 versions:
export _LCD_3_DrawVBG
export _LCD_3_DrawBG

IF SYSTEM_SMALL_MEMORY_MODEL
; Legacy Fastcall versions:
export  LCD_3_DrawVBG
export  LCD_3_DrawBG
...
;
export   LCD_3_Write_Data
export  _LCD_3_Write_Data
...
LCD_3_Port:           equ    PRT2DR
LCD_3_PortMode0:      equ    PRT2DM0
LCD_3_PortMode1:      equ    PRT2DM1

LCD_3_E:              equ    10h
LCD_3_RW:             equ    40h
LCD_3_RS:             equ    20h

LCD_3_DATA_MASK:      equ    0Fh
LCD_3_READY_BIT:      equ    08h

LCD_3_DATA_READ:      equ    ( LCD_3_E | LCD_3_RW | LCD_3_RS )
LCD_3_CNTL_READ:      equ    ( LCD_3_E | LCD_3_RW )
LCD_3_PORT_WRITE:     equ    7Fh
LCD_3_PORT_MASK:      equ    7Fh

LCD_3_DISP_INC:       equ    03h
LCD_3_DISP_OFF:       equ    08h
LCD_3_DISP_ON:        equ    0Ch
LCD_3_4BIT_2LINE:     equ    2Ch
...
LCD_3_BG_CHAR_WIDTH:  equ    16     ; 16 characters in width
LCD_3_BG_SEG_WIDTH:   equ    80     ; 16 * 5 = 80
LCD_3_BG_COL_START:   equ     0     ; Always start in the left most column

                                  ; Offsets for 2x16, 2x20, 4x20
                                  ; Change these values for a custom LCD

LCD_3_ROW1_OFFSET:    equ    80h    ; Address/command offset for row 1
LCD_3_ROW2_OFFSET:    equ    C0h    ; Address/command offset for row 2
LCD_3_ROW3_OFFSET:    equ    94h    ; Address/command offset for row 1
LCD_3_ROW4_OFFSET:    equ    D4h    ; Address/command offset for row 2

LCD_3_BG_ROW1_OFFSET: equ    80h    ; Address/command offset for row 1
LCD_3_BG_ROW2_OFFSET: equ    C0h    ; Address/command offset for row 2

LCD_3_CG_RAM_OFFSET:  equ    40h    ; Offset to character RAM

AREA UserModules (ROM, REL)

.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LCD_3_PrCString
;
;  DESCRIPTION:
...
.LCD_PrCString_WR:
    call  LCD_3_WriteData              ; Write data to LCD
...
_LCD_3_PrHexByte:
    ...
    index LCD_3_HEX_STR                  ; Get Hex value
    call  LCD_3_WriteData              ; Write data to screen
    pop   A                            ; Restore value
...
_LCD_3_PrHexInt:
    RAM_PROLOGUE RAM_USE_CLASS_1
    swap  A,X
    call  LCD_3_PrHexByte              ; Print MSB
    mov   A,X                          ; Move LSB into position
    call  LCD_3_PrHexByte              ; Print LSB
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
_LCD_3_PrString:
 ...
 .Loop_PrString:
    ...
    ;LCD_3_writeData is known not to modify X so no need to preserve
    call  LCD_3_WriteData              ; Write data to screen
...
;
 LCD_3_WriteData:
_LCD_3_WriteData:
 LCD_3_Write_Data:   ; Do not use
_LCD_3_Write_Data:   ; Do not use
    RAM_PROLOGUE RAM_USE_CLASS_1
    call  LCD_3_Check_Ready            ; Make sure controller is ready
                                       ; A is preserved in LCD_3_Check_Ready
    ...
    call  LCD_3_WDATA_Nibble           ; Write Upper nibble
    pop   A                            ; Retrieve copy of character
    and   A,0Fh                        ; Mask off high nibble
    nop
    nop
    nop
    call  LCD_3_WDATA_Nibble   ; Write Lower nibble
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
_LCD_3_Control:
    ...
    call  LCD_3_WCNTL_Nibble           ; Write high nibble
    pop   A                            ; Restore copy of byte
    and   A,0Fh                        ; Mask off high nibble
    nop
    nop
    nop
    call  LCD_3_WCNTL_Nibble             ; Write Lower nibble
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LCD_3_WCNTL_Nibble
;
;  DESCRIPTION:
...
;
 LCD_3_WCNTL_Nibble:
    ...
    and   [Port_2_Data_SHADE],~LCD_3_PORT_MASK
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_3_Port],A                      ; Reset control lines

    pop   A
    and   A,LCD_3_DATA_MASK                      ; Make sure no bogus data in MSN
    or    A,LCD_3_E                              ; Bring "E" Enable line high
    or    A,[Port_2_Data_SHADE]                  ; OR in bit 7 just
    mov   reg[LCD_3_Port], A                     ; Write data
    mov   [Port_2_Data_SHADE],A                  ; Keep shadow register in sync
    nop
    and   A,(~LCD_3_PORT_MASK|LCD_3_DATA_MASK)   ; Disable E signal and leave data on bus.
    mov   [Port_2_Data_SHADE],A                  ; Keep shadow register in sync
    mov   reg[LCD_3_Port],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LCD_3_WDATA_Nibble
;
;  DESCRIPTION:
...
LCD_3_WDATA_Nibble:
    ...
    RAM_SETPAGE_CUR >Port_2_Data_SHADE          ; Set CUR_PP to LCD variable address
    and   [Port_2_Data_SHADE],~LCD_3_PORT_MASK
    or    [Port_2_Data_SHADE],LCD_3_RS                ; Raise RS to signify a Data Write
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_3_Port],A

    pop   A
    and   A,LCD_3_DATA_MASK                           ; Make sure no bogus data in A[7:4]
    or    A,(LCD_3_E | LCD_3_RS)                      ; Bring "E" Enable line high
    or    A,[Port_2_Data_SHADE]                       ; Keep shadow in sync
    mov   reg[LCD_3_Port], A                            ; Write data
    mov   [Port_2_Data_SHADE],A                       ; Keep shadow in sync
    NOP
    and   A,(~LCD_3_PORT_MASK|LCD_3_DATA_MASK|LCD_3_RS)  ; Disable E signal and leave Data on bus
    mov   [Port_2_Data_SHADE],A                       ; keep shadow in sync
    mov   reg[LCD_3_Port],A
    RAM_EPILOGUE RAM_USE_CLASS_4
    ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LCD_3_Check_Ready
;
;  DESCRIPTION:
...
LCD_3_Check_Ready:
    ...
    RAM_SETPAGE_CUR >Port_2_Data_SHADE                ; Set CUR_PP to LCD variable address
    and   [Port_2_Data_SHADE],~LCD_3_PORT_MASK        ; Mask of all LCD bits
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_3_Port],A                           ; Zero LCD port bits

    and   [Port_2_DriveMode_0_SHADE],~LCD_3_DATA_MASK ; Clear out LCD mode bits.
    mov   A,[Port_2_DriveMode_0_SHADE]
    M8C_SetBank1                                      ; Change port mode to read status
    mov   reg[LCD_3_PortMode0],A                      ; Setup LCD Port for reading
    M8C_SetBank0

    or    [Port_2_Data_SHADE],LCD_3_RW                ; Raise RW to signify Read operation
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_3_Port],A
    NOP
...
.LCD_RDY_LOOP:
    or    [Port_2_Data_SHADE], LCD_3_CNTL_READ                  ; Raise E to start cycle
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_3_Port],A

    nop                                               ; Wait 2 nops to make sure data is ready
    nop
    mov   A,reg[LCD_3_Port]
...
ENDIF   
    ...
    push  A
    and   [Port_2_Data_SHADE],(~LCD_3_PORT_MASK | LCD_3_RW)     ; Lower E signal
    mov   A,[Port_2_Data_SHADE]
    mov   reg[LCD_3_Port],A
    ...
    pop   A
    and   A,LCD_3_READY_BIT                                       ; Check busy
...
.UNLOCK:
    ...
    or    [Port_2_DriveMode_0_SHADE],LCD_3_PORT_WRITE ; Revert Data bit to Write mode
    mov   A,[Port_2_DriveMode_0_SHADE]
    M8C_SetBank1
    mov   reg[LCD_3_PortMode0],A                      ; Setup LCD Port for writing
    M8C_SetBank0
    pop   A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LCD_3_Start
;  FUNCTION NAME: LCD_3_Init
;
;  DESCRIPTION:
;     Initialize LCD
;
...
_LCD_3_Init:
    ...
    and   [Port_2_DriveMode_0_SHADE],~LCD_3_PORT_MASK           ; Mask off LCD bits
    or    [Port_2_DriveMode_0_SHADE],LCD_3_PORT_WRITE           ; Set LCD port for writing
    and   [Port_2_DriveMode_1_SHADE],~LCD_3_PORT_MASK           ; Mask off LCD bits

    mov   A,[Port_2_DriveMode_0_SHADE]
    M8C_SetBank1
    mov   reg[LCD_3_PortMode0],A                                ; Setup LCD Port for writing
    mov   A,[Port_2_DriveMode_1_SHADE]
    mov   reg[LCD_3_PortMode1],A
    M8C_SetBank0

    mov   A,250                             ; Delay for 12.5 mSec (250 * 50uSec)
    call  LCD_3_Delay50uTimes
    mov   A,250                             ; Delay for 12.5 mSec (250 * 50uSec)
    call  LCD_3_Delay50uTimes

    mov   A,03h
    call  LCD_3_WCNTL_Nibble
    ...
    mov   A,LCD_3_4BIT_2LINE                  ; Setup for 4 bit interface, 2 line
    call  LCD_3_Control

    mov   A,LCD_3_DISP_OFF
    call  LCD_3_Control

    mov   A,LCD_3_DISP_ON
    call  LCD_3_Control

    mov   A,LCD_3_DISP_INC
    call  LCD_3_Control
...
.LITERAL
LCD_3_ROW_OFFSET::
     DB    LCD_3_ROW1_OFFSET, LCD_3_ROW2_OFFSET, LCD_3_ROW3_OFFSET, LCD_3_ROW4_OFFSET
.ENDLITERAL
...
_LCD_3_Position:
    ...
    push  X                            ; Store COL
    index LCD_3_ROW_OFFSET ; Get ROW memory offset from table
    mov   X,SP                         ; Get Stack pointer
    add   A,[X+(-1)]                   ; Add the COL to the display pointer
    pop   X

    call  LCD_3_Control                ; Write control byte
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LCD_3_Delay50uTimes
;
;  DESCRIPTION:
...
;
 LCD_3_Delay50uTimes:
_LCD_3_Delay50uTimes:
    RAM_PROLOGUE RAM_USE_CLASS_1
    call  LCD_3_Delay50u
    dec   A
    jnz   LCD_3_Delay50uTimes
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
...
.SECTION
 ...
 _LCD_3_Delay50u:                      ; [11]  Call
    ...
    cmp   A,05h
    jnc   .Delay50u_End
    index LCD_3_Delay50u_Table ; [13] Get delay value
.Delay50u_Loop:                          ;
    dec   A                              ; [4]
    jnz   .Delay50u_Loop                 ; [5]
.Delay50u_End:
...
;  ** function in assembly you should convert to _LCD_3_DrawVBG
...
;    functions.
;
;    If LCD_3_Init is not called before this function, the
...
LCD_3_DrawBG:
    ...
    call  LCD_3_Position               ; Set cursor position
...
.LCD_BG_DOITX:
    call  LCD_3_WriteData              ; Display BG character
...
.VBG_LOOPX:
    push  A
    index LCD_3_ROW_OFFSET  ; Get row offset
    add   A,[X+VBG_COLX]                ; Add column offset to position
    call  LCD_3_Control                ; Position Cursor
...
.VBG_WRITE_CHARX:                        ; Write character to display
    call  LCD_3_WriteData              ; Write value
    pop   A
    dec   A
...
_LCD_3_InitVBG:
    ...
    mov   A,LCD_3_CG_RAM_OFFSET              ; Setup pointer
    call  LCD_3_Control                ; Position the CG pointer
...
.VBG_Load:
    call  LCD_3_WriteData              ; character data
    ...
    pop  A
    pop  A
    mov  A,LCD_3_DISP_ON                    ; Turn on display, don't really
    call LCD_3_Control                 ; need this.
    RAM_EPILOGUE RAM_USE_CLASS_2
    ret
.ENDSECTION

;-----------------------------------------------------------------------------
;  FUNCTION NAME: LCD_3_InitBG
;
;  DESCRIPTION:
...
_LCD_3_InitBG:
 ...
 .BG_Loop2:
    ...
    jnz   .BG_OTHER
    index LCD_3_BG_TYPE1
    jmp   .BG_Load
 .BG_OTHER:
    index LCD_3_BG_TYPE2
 .BG_Load:
    call  LCD_3_WriteData
