...
export  RX_TIMEOUT_bReadCompareValue
export _RX_TIMEOUT_bReadCompareValue
export  RX_TIMEOUT_bReadTimer
export _RX_TIMEOUT_bReadTimer
export  RX_TIMEOUT_bReadTimerSaveCV
export _RX_TIMEOUT_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bRX_TIMEOUT_ReadCompareValue  ; deprecated
export _bRX_TIMEOUT_ReadCompareValue  ; deprecated
export  bRX_TIMEOUT_ReadTimer         ; deprecated
export _bRX_TIMEOUT_ReadTimer         ; deprecated
export  bRX_TIMEOUT_ReadTimerSaveCV   ; deprecated
export _bRX_TIMEOUT_ReadTimerSaveCV   ; deprecated

export  bRX_TIMEOUT_ReadCounter       ; obsolete
export _bRX_TIMEOUT_ReadCounter       ; obsolete
export  bRX_TIMEOUT_CaptureCounter    ; obsolete
export _bRX_TIMEOUT_CaptureCounter    ; obsolete
...
_RX_TIMEOUT_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[RX_TIMEOUT_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_RX_TIMEOUT_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[RX_TIMEOUT_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 RX_TIMEOUT_bReadCompareValue:
_RX_TIMEOUT_bReadCompareValue:
 bRX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
_bRX_TIMEOUT_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[RX_TIMEOUT_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 RX_TIMEOUT_bReadTimerSaveCV:
_RX_TIMEOUT_bReadTimerSaveCV:
 bRX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
_bRX_TIMEOUT_ReadTimerSaveCV:                    ; this name deprecated
 bRX_TIMEOUT_ReadCounter:                        ; this name deprecated
_bRX_TIMEOUT_ReadCounter:                        ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[RX_TIMEOUT_CONTROL_REG]          ; save the Control register
   push  A
   mov   A, reg[RX_TIMEOUT_COMPARE_REG]          ; save the Compare register
   push  A
   mov   A, reg[RX_TIMEOUT_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[RX_TIMEOUT_COMPARE_REG]          ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: RX_TIMEOUT_bReadTimer
;
;  DESCRIPTION:
...
;
 RX_TIMEOUT_bReadTimer:
_RX_TIMEOUT_bReadTimer:
 bRX_TIMEOUT_ReadTimer:                          ; this name deprecated
_bRX_TIMEOUT_ReadTimer:                          ; this name deprecated
 bRX_TIMEOUT_CaptureCounter:                     ; this name deprecated
_bRX_TIMEOUT_CaptureCounter:                     ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[RX_TIMEOUT_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[RX_TIMEOUT_COMPARE_REG]          ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
